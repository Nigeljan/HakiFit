            ...
            <span class="wrkctg-span1">
                <button type="submit">
                    <a href="HakiFit_Category_Cardio.jsp">
                        <img src="Images/Cardio.jpg"  class="wrkctg-highknees"><p class="wrkctg-highkneesp">Cardio
                        </p></a></button>
            </span>
            ...
            <span class="wrkctg-span2">
                <button type="submit">
                    <a href="HakiFit_Category_StrengthTraining.jsp">
                        <img src="Images/Strength_Training.jpg" class="wrkctg-squatjumps"><br><p class="wrkctg-highkneesp">Strength Training</p>
                    </a></button>
            </span>
            ...
            <span class="wrkctg-span3">
                <button type="submit">
                    <a href="HakiFit_Category_Yoga.jsp">
                        <img src="Images/Yoga.jpg" class="wrkctg-jogging"><br><p class="wrkctg-highkneesp">Yoga</p>
                    </a></button>
            </span>
        </div>
