<%-- Document : Yoga Created on : 12 2, 23, 3:34:58 PM Author : Nigel Jan Naniong --%>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <% response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate" );
            ...
            <body class="wrkctg-body">
                ...
                <p class="wrkctg-p"> Yoga workouts involve a series of poses, stretches, and controlled breathing
                    techniques <br>
                    ...
                    <span class="wrkctg-span1">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                <img src="Images/Yoga.jpg" class="wrkctg-highknees">
                                <p class="wrkctg-highkneesp">Start Workout
                                </p>
                            </a></button>
                    </span>
                </div>
