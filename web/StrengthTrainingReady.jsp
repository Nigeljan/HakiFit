<%-- 
    Document   : StrengthTrainingReady
    Created on : 12 3, 23, 11:43:53 AM
...
<html>
    ...
    <body class="wrkctg-body">
        ...
        <h1 class="wrkctg-h1">Are you Ready??</h1><br>
        ...
        <div class="wrkctg-div">
            <span class="wrkctg-span1">
                <button type="submit">
                    <a href="Timer.jsp">
                        <img src="Images/Strength_Training.jpg"  class="wrkctg-highknees"><p class="wrkctg-highkneesp">Start Workout
                        </p></a></button>
            </span>
            ...
            <span class="wrkctg-span2">
                <button type="submit">
                    <a href="TrackProgress.jsp"">
                        <img src="Images/Track Progress.png" class="wrkctg-squatjumps"><br><p class="wrkctg-highkneesp">Track Progress</p>
                    </a></button>
            </span>
