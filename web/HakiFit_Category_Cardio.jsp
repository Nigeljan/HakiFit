<%-- Document : Cardio Created on : 12 2, 23, 3:34:47 PM Author : Nigel Jan Naniong --%>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <% response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate" );
            ...
            <body class="wrkctg-body">
                ...
                <p class="wrkctg-p"> Cardio exercises, short for cardiovascular exercises, are activities that elevate
                    your heart <br>
                ...
                <div class="wrkctg-div">
                    <span class="wrkctg-span1">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                ...
                                <p class="wrkctg-highkneesp">High Knees
                                </p>
                            </a></button>
                    </span>
                    ...
                    <span class="wrkctg-span2">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                <img src="Images/Squat Jumps.jpg" class="wrkctg-squatjumps"><br>
                    ...
                    <span class="wrkctg-span3">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                <img src="Images/Jogging.jpg" class="wrkctg-jogging"><br>
                                <p class="wrkctg-highkneesp">Jogging</p>
                            </a></button>
                    </span>
                </div>
