...
<html>
    ...
    <body class="wrkctg-body">
        ...
        <h1 class="wrkctg-h1">Nutrition</h1><br>
        
        <p class="wrkctg-p">Meal Plans or Recipes??</p>
        
        <div class="wrkctg-div">
            <span class="wrkctg-span1">
                <button type="submit">
                    <a href="Recipe.jsp">
                        <img src="Images/Meal Plan.jpg"  class="wrkctg-highknees"><p class="wrkctg-highkneesp">Meal Plans
                        </p></a></button>
            </span>
            ...
            <span class="wrkctg-span2">
                <button type="submit">
                    <a href="Recipe.jsp">
                        <img src="Images/Recipe.jpg" class="wrkctg-squatjumps"><br><p class="wrkctg-highkneesp">Recipes</p>
                    </a></button>
            </span>
