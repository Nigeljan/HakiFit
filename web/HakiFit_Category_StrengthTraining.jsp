<%-- Document : StrengthTraining Created on : 12 2, 23, 3:34:37 PM Author : Nigel Jan Naniong --%>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <% response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate" );
            ...
            <body class="wrkctg-body">
                ...
                <p class="wrkctg-p"> Strength training involves performing exercises that target specific muscle groups,
                    utilizing <br>
                    ...
                    <span class="wrkctg-span1">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                ...
                                <p class="wrkctg-highkneesp">Squats
                                </p>
                            </a></button>
                    </span>
                    ...
                    <span class="wrkctg-span2">
                        <button type="submit">
                            <a href="HakiFit_Exercise_Ready.jsp">
                                ...
                                <p class="wrkctg-highkneesp">Bicep Curls</p>
                            </a></button>
                    </span>
