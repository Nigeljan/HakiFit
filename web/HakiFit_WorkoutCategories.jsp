...
<html>
    ...
    <body class="wrkctg-body">
        ...
        <form action="CategorySelection" method="post">
        <div class="wrkctg-div">
            <span class="wrkctg-span1">
                <button type="submit" name="button" value="cardio">
                        <img src="Images/Cardio.jpg"  class="wrkctg-highknees">
                        <p class="wrkctg-highkneesp">Cardio</p>
                </button>
            </span>

            <span class="wrkctg-span2">
                <button type="submit" name="button" value="strengthTraining">
            ...
            <span class="wrkctg-span3">
                <button type="submit" name="button" value="yoga">
