...
<html>
    ...
    <body class="wrkctg-body">
        ...
        <div class="wrkctg-div">
            <span class="wrkctg-span1"><button type="submit"><a href="CardioReady.jsp"><img src="Images/High Knees.jpg"  class="wrkctg-highknees">High Knees</a></button></span>
            <span class="wrkctg-span2"><button type="submit"><a href="CardioReady.jsp"><button type="submit"><img src="Images/Squat Jumps.jpg" class="wrkctg-squatjumps">Squat Jumps</a></button></span>
            <span class="wrkctg-span3"><button type="submit"><a href="CardioReady.jsp"><button type="submit"><img src="Images/Jogging.jpg" class="wrkctg-jogging">Jogging</a></button></span>
        </div>
    </body>
</html>
