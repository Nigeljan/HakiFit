...
<html>
    ...
    <body class="wrkctg-body">
        ...
        <h4 class="wrkctg-h1">This side doesn't work</h4>  
        ...
        <div class="wrkctg-div3"> 
            <p class="wrkctg-p2">Category: <%= buttonValue_fromp1 %>  </p>
            <p class="wrkctg-p2">Exercise: <%= buttonValue_fromp2 %> </p>
            <p class="wrkctg-p2">Time of Exercise: <%= elapsedTime %></p>
        </div>
